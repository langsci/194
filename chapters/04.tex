...
\pagebreak\subsection{Interpretation of the semantic field of \textit{beginnen}\slash inchoativity for SourceDutch}
\label{sec:4.2.4}  
...
\subsubsection{Medoids}\label{sec:4.3.3.2}\largerpage[2]
...
\subsection{Interpretation of the semantic field of \textit{beginnen}/inchoativity for TransDutch\textsubscript{ENG}}\label{sec:4.3.4}
...
\subsubsection{Onomasiological shining through of French}\label{sec:4.6.2.2}\largerpage  
