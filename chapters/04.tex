\chapter{Results}
\section{\label{sec:4.1}  Introduction}
...
\section{\label{sec:4.2}  SourceDutch}
\subsection{\label{sec:4.2.1}  Results of the Hierarchical Agglomerative Cluster analysis}
...
\begin{figure}\includegraphics[height=.3\textheight]{figures/Vandevoorde2-img54.png}
 


\begin{caption}
{\label{fig:key:54}}{  K-means clustering with 6 clusters for SourceDutch}
\end{caption}
\end{figure}
...
\subsection{\label{sec:4.2.2}  Prototype-based organization of the clusters in the dendrogram (semasiological level)}
...
\subsection{\label{sec:4.2.3}  Prototype-based organization of the lexemes within each cluster (onomasiological level)}
...
\subsubsection{\label{sec:4.2.3.1}  Centroids}
...
\begin{figure}\includegraphics[height=.3\textheight]{figures/Vandevoorde2-img57.png}
...
\subsubsection{\label{sec:4.2.3.2}  Medoids}
...
\section{\label{sec:4.3}  TransDutch\textsubscript{ENG}}
...
\subsection{\label{sec:4.3.1}  Results of the Hierarchical Agglomerative Cluster analysis}
...
\subsection{\label{sec:4.3.2}  Prototype-based organization of the clusters in the dendrogram (semasiological level)}
...
\subsection{\label{sec:4.3.3}  Prototype-based organization of the lexemes within each cluster (onomasiological level)}
...
\subsubsection{\label{sec:4.3.3.1}  Centroids}
...
\subsubsection{\label{sec:4.3.3.2}  Medoids}
...
\begin{table}\caption{
Table~15  Comparison of medoids and lexemes closest to the centroids for TransDutch\textsubscript{ENG}
}
\label{tab:key:}
...
\subsection{\label{sec:4.3.4}  Interpretation of the semantic field of beginnen\textit{/}inchoativity for TransDutch\textsubscript{ENG}}
...
\section{\label{sec:4.4}  TransDutch\textsubscript{FR}}
...
\subsection{\label{sec:4.4.1}  Results of the Hierarchical Agglomerative Cluster analysis}
...
\subsection{\label{sec:4.4.2}  Prototype-based organization of the clusters in the dendrogram (semasiological level)}
...
\subsection{\label{sec:4.4.3}  Prototype-based organization of the lexemes within each cluster (onomasiological level)}
...
\subsubsection{\label{sec:4.4.3.1}  Centroids}
...
\subsubsection{\label{sec:4.4.3.2}  Medoids}
...
\begin{table}\caption{
Table~16  Comparison of medoids and lexemes closest to the centroids for TransDutch\textsubscript{FR}
}
\label{tab:key:}
...
\subsection{\label{sec:4.4.4}  Interpretation of the semantic field of \textit{beginnen/}inchoativity for TransDutch\textsubscript{FR}}
...
\section{\label{sec:4.5}  Levelling out}
...
\begin{itemize}
\item 
In TransDutch\textsubscript{ENG}, the REFERENCE CLUSTER contains the meaning distinctions \textit{eerst} and {NON-LEXICALIZED INCHOATIVITY} in addition to GENERAL ONSET (the only meta-label for this cluster in SourceDutch). The distinction between ACTION and STATE AFTER ONSET remains unclear on the semasiological level for TransDutch\textsubscript{ENG}.
\item 
In TransDutch\textsubscript{FR}, the REFERENCE CLUSTER contains the meaning distinctions \textit{eerst} and {NON-LEXICALIZED INCHOATIVITY} in addition to GENERAL ONSET (the only meta-label for this cluster in SourceDutch). It does not, however, contain the meaning distinction ACTION.
\item 
In both TransDutch visualizations, more meaning distinctions become part of the REFERENCE CLUSTER compared to SourceDutch. In both TransDutch fields, the meaning distinctions \textit{eerst} and {NON-LEXICALIZED INCHOATIVITY} become part of the REFERENCE CLUSTER, implying that they are used more prominently in TransDutch compared to SourceDutch.
\end{itemize}
\begin{figure}
...
\begin{itemize}
\item 
In TransDutch\textsubscript{ENG}, \textit{begin} forms a distinct cluster, whereas in SourceDutch, \textit{begin} was part of GENERAL ONSET (NOUN). This division on the semasiological level suggests an additional meaning distinction within GENERAL ONSET (NOUN) in TransDutch\textsubscript{ENG}.
\end{itemize}
\begin{figure}
...
\subsection{\label{sec:4.5.2}  Onomasiological changes in the prototype-based organization}
...
\section{\label{sec:4.6}  Shining through}
\subsection{\label{sec:4.6.1}  Semasiological shining through}
...
\subsubsection{\label{sec:4.6.1.1}  Semasiological shining through of SourceEnglish}
...
\subsubsection{\label{sec:4.6.1.2}  Semasiological shining through of SourceFrench}
...
\subsection{\label{sec:4.6.2}  Onomasiological shining through}
...
\subsubsection{\label{sec:4.6.2.1}  Onomasiological shining through of English}
...
\subsubsection{\label{sec:4.6.2.2}  Onomasiological shining through of French}
...
\section{\label{sec:4.7}  Normalization}
\subsection{\label{sec:4.7.1}  Semasiological normalization}
...
\subsection{\label{sec:4.7.2}  Onomasiological normalization}
...
\section{\label{sec:4.8}  Conclusion}
