...
\glt `Someone mentioned for example: “About 80 percent of the graduates of our academy of arts will begin a career in the creative industry”.'\\
...
\todo{Where should the enumerated list end?}\begin{enumerate}
...
\glt `Entrepreneurs feverishly began to look for targets for cut backs'\\
...
\glt `While the European Union begins gradually to prepare itself to welcome 10 new member states, the European economy reamins a sluggish affair.'\\
...
\glt `Thanks to technological development, more and more plasma applications are popping up in our daily live. Think of striplighting or the flat plasma screen of television sets.'
\z
...
\glt `The hilly path starts from the townsite of Saint Paul’s near the chapel, crosses the Reynès bridge and goes up across the mountain to the village.' 
\z
...
\glt `As far as the tourist railway of the Tarn concerns, it starts off in the old station for steam trams of the Tarn in the centre of Saint-Lieux.'
\z
...
\glt `Laplanches comment indeed stems from the idea that the eros connection is as such as work “in a narcissistic way”, because it tends, so he says, to “the becoming of one” (Lacan).'
\z
...
\glt `Note that we are launching and developing a number of tools to bring this music-loving community even more to life.'\\
...
\glt `We are by the way very busy developing tools to bring more gusto in this community of music lovers.'
\z
...
\glt `The jeans brand Diesel has, for example, launched a contest for its Facebook members, via an application baptized ‘how do you live with your Diesel?'.'\\
...
\glt `The jeans brand Diesel developed an application for a contest amongst Facebook members, ‘how do you live with your Diesel?’.'
\z
...
\todo[inline]{This sections needs a heading for the content before Subsection 3.7.1.}
