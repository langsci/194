...
\begin{table}
\caption{First T-image of beginnen\textsubscript{ENG} (raw frequencies)\todo[inline]{I split the rows  in 2 and placed them besides each other}\label{tab:key:5}}
...
Chaining effect
\caption{Divise clustering of the field of TransDutch\textsubscript{ENG}, displaying chaining effect \label{fig:key:28}  }
\end{figure}
