...
Chaining effect
\caption{\label{fig:3:28}Divise clustering of the field of TransDutch\textsubscript{ENG}, displaying chaining effect\todo[inline]{Chaining effect not displaying correctly}}
\end{figure}
...
Space dilation
\caption{\label{fig:3:29} Agglomerative clustering of the field of SourceDutch, displaying space-dilation\todo[inline]{Space dilation not displaying correctly}}
\end{figure}
